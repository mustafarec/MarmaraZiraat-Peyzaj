...
class YaprakGubresiProductDetail extends StatelessWidget {
  final int pageId;
  const YaprakGubresiProductDetail({Key? key, required this.pageId}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var product = Get.find<YaprakGubreleriProductController>().yaprakGubreleriproductList[pageId];
    return Scaffold(
