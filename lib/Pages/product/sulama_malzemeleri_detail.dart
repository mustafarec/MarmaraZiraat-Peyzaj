...
class SulamaMalzemeriProductDetail extends StatelessWidget {
  final int pageId;
  const SulamaMalzemeriProductDetail({Key? key, required this.pageId}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var product = Get.find<SulamaMalzemeleriProductController>().sulamaMalzemeleriproductList[pageId];
    return Scaffold(
