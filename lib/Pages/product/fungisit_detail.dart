...
class FungisitProductDetail extends StatelessWidget {
  final int pageId;
  const FungisitProductDetail({Key? key, required this.pageId}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var product = Get.find<FungisitProductController>().fungisitproductList[pageId];
    return Scaffold(
