...
class HerbisitProductDetail extends StatelessWidget {
  final int pageId;
  const HerbisitProductDetail({Key? key, required this.pageId}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var product = Get.find<HerbisitProductController>().herbisitproductList[pageId];
    return Scaffold(
