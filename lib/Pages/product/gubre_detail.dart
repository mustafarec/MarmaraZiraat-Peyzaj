...
class GubreProductDetail extends StatelessWidget {
  final int pageId;
  const GubreProductDetail({Key? key, required this.pageId}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var product = Get.find<GubreProductController>().gubreproductList[pageId];
    return Scaffold(
