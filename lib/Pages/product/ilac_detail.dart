...
class IlacProductDetail extends StatelessWidget {
  final int pageId;
  const IlacProductDetail({Key? key, required this.pageId}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var product = Get.find<IlacProductController>().ilacproductList[pageId];
    return Scaffold(
