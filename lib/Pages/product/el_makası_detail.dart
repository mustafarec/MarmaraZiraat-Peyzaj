...
class ElMakasiProductDetail extends StatelessWidget {
  final int pageId;
  const ElMakasiProductDetail({Key? key, required this.pageId}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var product = Get.find<MakasProductController>().makasproductList[pageId];
    return Scaffold(
