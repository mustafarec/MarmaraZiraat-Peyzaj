...
class MollositProductDetail extends StatelessWidget {
  final int pageId;
  const MollositProductDetail({Key? key, required this.pageId}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var product = Get.find<MollositProductController>().mollositproductList[pageId];
    return Scaffold(
