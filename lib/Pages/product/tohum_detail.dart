...
class TohumProductDetail extends StatelessWidget {
  final int pageId;
  const TohumProductDetail({Key? key, required this.pageId}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var product = Get.find<TohumProductController>().tohumproductList[pageId];
    return Scaffold(
