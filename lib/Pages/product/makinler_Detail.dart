...
class MakinelerProductDetail extends StatelessWidget {
  final int pageId;
  const MakinelerProductDetail({Key? key, required this.pageId}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var product = Get.find<MakineProductController>().makineproductList[pageId];
    return Scaffold(
