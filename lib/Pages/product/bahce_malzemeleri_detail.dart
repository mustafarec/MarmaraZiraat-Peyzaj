...
class BahceMalzemeriProductDetail extends StatelessWidget {
  final int pageId;
  const BahceMalzemeriProductDetail({Key? key, required this.pageId}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var product = Get.find<BahceMalzemeleriProductController>().bahceMalzemeleriproductList[pageId];
    return Scaffold(
