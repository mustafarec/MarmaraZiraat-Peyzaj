...
class InsektisitProductDetail extends StatelessWidget {
  final int pageId;
  const InsektisitProductDetail({Key? key, required this.pageId}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var product = Get.find<InsektisitProductController>().insektisitproductList[pageId];
    return Scaffold(
