...
class AkarisitProductDetail extends StatelessWidget {
  final int pageId;
  const AkarisitProductDetail({Key? key, required this.pageId}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var product = Get.find<AkarisitProductController>().akarisitproductList[pageId];
    return Scaffold(
