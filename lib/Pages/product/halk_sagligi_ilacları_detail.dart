...
import '../../widgets/same_product_widget.dart';

class HalkSagligiProductDetail extends StatelessWidget {
  final int pageId;
  const HalkSagligiProductDetail({Key? key, required this.pageId}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var product = Get.find<HalkSagligiProductController>().halksagligiproductList[pageId];
    return Scaffold(
